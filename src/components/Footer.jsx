    ...
    <footer className="footer">
      <div className="footer-wave">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path d="M0,120 Q150,60 300,90 T600,80 T900,70 T1200,60 L1200,120 Z" fill="currentColor"/>
        </svg>
      </div>
      ...
      <div className="footer-container">
          ...
          <div className="footer-section">
            ...
            <div className="section-content">
              ...
              <p className="contact-item">
                ...
                <a href="https://wa.me/5581982307332">(81) 98230-7332</a>
              </p>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-social">
            ...
            <a href="https://wa.me/5581982307332" className="social-link" aria-label="WhatsApp">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
